<template>
  ...
  <div class="relative mx-auto w-full" style="max-width:120px;aspect-ratio:120/104">
    <svg viewBox="0 0 120 104" class="w-full h-full text-ink">
      <!-- Track -->
      <path :d="trackPath" fill="none" stroke="currentColor" stroke-opacity="0.12"
        stroke-width="6" stroke-linecap="round" />
      <!-- Filled value arc -->
      <path :d="valuePath" fill="none" stroke="#2b7fff" stroke-width="6" stroke-linecap="round" />
      <!-- Knob -->
      <circle :cx="knob.x" :cy="knob.y" r="5" fill="#2b7fff" stroke="white" stroke-width="2" />
    </svg>
